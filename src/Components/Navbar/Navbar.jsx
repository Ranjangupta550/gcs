...
import { ServerStatus, SetIpAddress } from "../../index.js";
...
function Navbar() {
  ...
  return (
    <>
      <div
        id="Navbar"
        className="bg-navbar h-11 w-full flex items-center justify-between  relative"
      >
        <div className="Status-bar h-full flex items-center justify-center">
          ...
          <div
            id="SatelliteCount"
            className="flex w-20 h-full justify-evenly pt-1"
          >
          ...
          <div
            ...
            className="flex w-44  items-center  justify-evenly "
          >
        ...
        <div className="LeftSidebar w-auto pr-2 flex gap-4 justify-center items-center">
          ...
          <div className="flex item-center justify-center gap-x-6  ">
